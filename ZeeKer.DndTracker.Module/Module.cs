...
namespace ZeeKer.DndTracker.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class DndTrackerModule : ModuleBase {
    public DndTrackerModule() {
		// 
		// DndTrackerModule
		// 
		AdditionalExportedTypes.Add(typeof(ZeeKer.DndTracker.Module.BusinessObjects.ApplicationUser));
