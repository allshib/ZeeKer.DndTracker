...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<DndTrackerWindowsFormsApplication>();
        builder.Modules
            .AddCharts()
        	...
        	.Add<DndTrackerWinModule>();
        builder.ObjectSpaceProviders
            .AddSecuredEFCore(options => options.PreFetchReferenceProperties())
                .WithDbContext<ZeeKer.DndTracker.Module.BusinessObjects.DndTrackerEFCoreDbContext>((application, options) => {
        ...
        builder.Security
            .UseIntegratedMode(options => {
                ...
                options.UserType = typeof(ZeeKer.DndTracker.Module.BusinessObjects.ApplicationUser);
                options.UserLoginInfoType = typeof(ZeeKer.DndTracker.Module.BusinessObjects.ApplicationUserLoginInfo);
